...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.prestasi.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.prestasis.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="mahasiswa_id">{{ trans('cruds.prestasi.fields.mahasiswa') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.prestasi.fields.mahasiswa_helper') }}</span>
            </div>
            <div class="form-group">
                <label class="required" for="nama_lomba">{{ trans('cruds.prestasi.fields.nama_lomba') }}</label>
                <input class="form-control {{ $errors->has('nama_lomba') ? 'is-invalid' : '' }}" type="text" name="nama_lomba" id="nama_lomba" value="{{ old('nama_lomba', '') }}" required>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('bidang_lomba') ? 'is-invalid' : '' }}" name="bidang_lomba" id="bidang_lomba" required>
                    ...
                    @foreach(App\Models\Prestasi::BIDANG_LOMBA_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('bidang_lomba', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('tanggal_pelaksanaan') ? 'is-invalid' : '' }}" type="text" name="tanggal_pelaksanaan" id="tanggal_pelaksanaan" value="{{ old('tanggal_pelaksanaan') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tempat_pelaksanaan') ? 'is-invalid' : '' }}" type="text" name="tempat_pelaksanaan" id="tempat_pelaksanaan" value="{{ old('tempat_pelaksanaan', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('prestasi_juara') ? 'is-invalid' : '' }}" type="text" name="prestasi_juara" id="prestasi_juara" value="{{ old('prestasi_juara', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tingkat') ? 'is-invalid' : '' }}" type="text" name="tingkat" id="tingkat" value="{{ old('tingkat', '') }}" required>
            ...
            <div class="form-group">
                <label class="required">{{ trans('cruds.prestasi.fields.status') }}</label>
                <select class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}" name="status" id="status" required>
                    <option value disabled {{ old('status', null) === null ? 'selected' : '' }}>{{ trans('global.pleaseSelect') }}</option>
                    @foreach(App\Models\Prestasi::STATUS_SELECT as $key => $label)
                ...
                @endif
                <span class="help-block">{{ trans('cruds.prestasi.fields.status_helper') }}</span>
            </div>
            <div class="form-group">
...
<script>
    ...
    url: '{{ route('admin.prestasis.storeMedia') }}',
    maxFilesize: 2, // MB
    maxFiles: 1,
    addRemoveLinks: true,
    headers: {
