        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                ...
                @can('data_mahasiswa_access')
                    <li
                        class="nav-item has-treeview {{ request()->is('frontend/mahasiswas*') ? 'menu-open' : '' }} {{ request()->is('frontend/prestasis*') ? 'menu-open' : '' }}">
                        <a class="nav-link nav-dropdown-toggle {{ request()->is('frontend/mahasiswas*') ? 'active' : '' }} {{ request()->is('frontend/prestasis*') ? 'active' : '' }}"
                            href="#">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            @can('prestasi_access')
                                <li class="nav-item">
                                    <a href="{{ route('frontend.prestasis.index') }}"
                                        class="nav-link {{ request()->is('frontend/prestasis') || request()->is('frontend/prestasis/*') ? 'active' : '' }}">
